...
export const CAMPAIGN_CATALOG: CampaignDef[] = [
  {
    ...
    bekanntheitGain: 2,
    copy: 'Anzeigen in Lokalzeitungen heben die Bekanntheit in NRW langsam — teuer, und ohne laufende Frachten kaum spürbar.',
    unlockLevel: 1,
  },
  {
    kind: 'online-banner',
    ...
    bekanntheitGain: 1,
    copy: 'Banner auf Logistikportalen machen dein EVU für Verlader sichtbar — geringer Reichweiten-Effekt, kein Schnellaufstieg.',
    unlockLevel: 3,
  },
  {
    kind: 'branchenmessen',
    ...
    bekanntheitGain: 10,
    copy: 'Stand auf einer Branchenmesse / Logistikmesse: hoher Aufwand, spürbarer, aber immer noch knapper Bekanntheit-Schub.',
    unlockLevel: 5,
  },
];
