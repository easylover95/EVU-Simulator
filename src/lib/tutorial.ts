...
export const TUTORIAL_STEPS: TutorialStep[] = [
  {
    ...
    description:
      'Das ist dein Büro — die Zentrale deines EVU. Du startest mit 210.000 €. Oben siehst du Konto, Uhr und Post. Die goldenen Markierungen im Raum sind dein Hauptmenü: klicke die Gegenstände, um Bereiche zu öffnen.',
