...
export const SEED_NOTIFICATIONS: Notification[] = [
  {
    ...
    message:
      'Start: 210.000 €, 2 Dieselloks (BR 218), 10 Güterwagen (6× Res, 4× Eanos), 2 Triebfahrzeugführer. Bekanntheit 0. Dispo 20.000 €. Weitere Tf und AZF/RB über die Jobbörse, Loks beim Händler.',
    read: false,
    created_at: nowIso,
  },
];
