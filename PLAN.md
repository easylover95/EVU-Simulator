...
### 1. Bilanz und GuV müssen Schuldendienst korrekt trennen
...
### 2. Jede neue Verpflichtung erhält eine zweistufige Bestätigung

- **Why isolated:** Kreditaufnahme, Sondertilgung, Dispo-Anpassung und Versicherung haben Geld-, Liquiditäts- oder Betriebsfolgen.
...
- **Assets needed:** `assets/reference-route-finance-cockpit.png` nur als visuelle QA-Referenz für die Finanzoberfläche. Keine generierte Laufzeitkarte erforderlich.
- **Verify:**
  - Jeder Finanz-Commit hat ein isoliertes Bestätigungsmodal mit sichtbarer Auswirkung.
...
Der vorhandene React/Vite-Stack, die lokale Speicherung und die `App.tsx`-Mutationsebene bleiben bestehen. Bestehende Leaflet-Live-Karte und die Disposition werden nicht ersetzt.
